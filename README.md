Teredo General Fix 0.6.0, Updated 01/03/2023.<br>
...
- If you still encounter problems you can try resetting you device network, you can find instruction on the EXTRAS (last one).
