...
If you think i skipped some infomration or you found an other solution not included here, you can create an issue here on github and i'll try to implement it inside the teredoFix.bat, the ultimate goal is to create a general fix for every teredo/openNAT-related problem in the xbox app / microsoft multiplayer.
